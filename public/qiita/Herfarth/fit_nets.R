...
load('Herfarthphyfilt.RData')

# load('HerfarthNetFits.RData')
...
se.poi <- spiec.easi(phy_taxfilt, method='poisson', nlambda=120,
...
save(se.gl, se.mb, se.is, se.poi, se.slr, file='HerfarthNetFits.RData')
